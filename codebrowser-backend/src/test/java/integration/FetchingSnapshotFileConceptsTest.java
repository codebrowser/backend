...
public class FetchingSnapshotFileConceptsTest extends BaseFetchingTest {
    ...
    public static void fetchPage() throws IOException {
        ...
        concepts = fetchJson("students/" + studentId + "/courses/" + courseId + "/exercises/" + exerciseId + "/snapshots/" + snapshotId + "/files/" + fileId + "/concepts");
    }
    ...
    public void badRequestIfInvalidId() throws IOException {
        testBadRequest("students/-1/courses/-1/exercises/-1/snapshots/-1/files/-1/concepts");
    }
}
